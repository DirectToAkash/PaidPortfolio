    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="text-center">
          ...
          {/* SEO-optimised H1 — keyword rich, visible to Google */}
          <motion.h1
          ...
          >
            ...
            <br />
            <span className="text-glow">for Students &amp; Developers</span>
          </motion.h1>

          {/* Visual tagline / subheading */}
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            We craft job-winning portfolio websites for students, developers, freshers, and
            freelancers across India. Stand out from the crowd with a stunning custom portfolio design.
          </motion.p>
