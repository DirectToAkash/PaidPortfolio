...
export default function BlogPremiumPortfolio() {
  ...
  // SEO: update document title and meta on mount
  useEffect(() => {
    ...
    <main className="min-h-screen bg-black pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p>You're entering one of the most competitive job markets in India's history. Thousands of students graduate every year with the same degree and the same resume format. A <strong>premium portfolio website for students</strong> gives you a massive edge:</p>
          <ul>
          ...
          <p><strong>Result:</strong> Students with portfolio websites get more interview calls, higher starting salaries, and faster career growth.</p>

          <h3>👨‍⚕️ Doctors &amp; Healthcare Professionals</h3>
          <p>A <strong>portfolio website for doctors</strong> is one of the most underutilised career tools in India's medical community — yet one of the most powerful:</p>
          <ul>
            ...
            <li>Position yourself for speaking engagements, conferences, and consulting roles</li>
            <li>Stand out when applying for fellowships, grants, or international positions</li>
          </ul>
          <p>When a patient searches "cardiologist in Delhi" or "best dermatologist Noida," a doctor with a professional portfolio website wins the appointment.</p>
          ...
          <ul>
            ...
            <li>Display testimonials from students, parents, and institutions</li>
            <li>Attract opportunities at better schools, ed-tech companies, or tutoring clients</li>
          ...
          <p>If you have 5, 10, or 15 years of experience, you deserve more than a LinkedIn profile. A <strong>personal portfolio website for experienced professionals</strong> gives you:</p>
          <ul>
          ...
          <table>
            <thead>
              <tr><th>Feature</th><th>Free Builder (Wix/Squarespace)</th><th>Paid Portfolio by PaidPortfolio</th></tr>
            </thead>
            <tbody>
          ...
          <p>A <strong>paid portfolio website</strong> is an investment, not an expense. The first job offer it helps you land pays for itself many times over.</p>
          ...
          <table>
            <thead>
              <tr><th>Package</th><th>Best For</th><th>What's Included</th></tr>
            </thead>
            <tbody>
          ...
          <blockquote>"I was applying for jobs for 6 months with zero callbacks. Within 2 weeks of my portfolio going live, I got 3 interview calls. The portfolio made all the difference." — Software Developer, Delhi</blockquote>
          <blockquote>"As a doctor, I never thought I needed a personal website. After PaidPortfolio built mine, I started getting direct consultation requests online. It changed my practice." — General Physician, Noida</blockquote>
          <blockquote>"My teaching portfolio helped me land a position at an international school. They said my website showed initiative that other candidates didn't have." — School Teacher, Mumbai</blockquote>

          <h2>Frequently Asked Questions</h2>
          <h3>What makes PaidPortfolio different from Wix or Squarespace?</h3>
          <p>Wix gives you a builder and leaves you alone. PaidPortfolio builds the entire website for you, custom from scratch. You get a better result in less time — with no monthly fees.</p>
        ...
        <motion.div
          ...
          className="mt-14 glass border border-white/10 rounded-2xl p-8 text-center"
        >
