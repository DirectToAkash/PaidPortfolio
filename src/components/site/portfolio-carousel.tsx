...
export function PortfolioCarousel() {
  ...
  const getCardStyle = (index: number): { x: number; scale: number; rotateY: number; z: number; opacity: number } => {
    if (templates.length === 0) return { x: 0, scale: 1, rotateY: 0, z: 0, opacity: 0 };
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-white/50 line-clamp-2 mb-4">{item.description}</p>
